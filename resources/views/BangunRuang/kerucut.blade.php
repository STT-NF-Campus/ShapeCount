...
<body id="top" style="background-color: #F4F9FD">
    ...
    <div class="container-fluid pb-5"
                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        ...
                        <div class="title pb-4">
                            <p class="fs-2 text-center text-primary fw-bold ">Hitung Luas Kerucut</p>
                        </div>
                        <!-- Form Input -->
                        <form method="POST" action="{{ route('kerucut.hitungLuas') }}#hasil">
                            @csrf
                            <div class="form-floating mb-5">
                                <input type="number" class="form-control border-1 border-dark" id="jarijari"
                                    @if (isset($data['jari'])) value="{{ $data['jari'] }}" @endif name="jarijari"
                                    placeholder="Jari-Jari">
                                <label for="jarijari">Jari-Jari</label>
                            </div>
                            <div class="form-floating mb-5">
                                <input type="number" class="form-control border-1 border-dark" id="sisi"
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="card border-2 border-dark shadow bg-primary" style="width: 25rem">
                            <img src="{{ asset('assets/dist/img/BangunRuang/Kerucut.png') }}" alt="shape.png" class="p-3 rounded-5 ">
                        </div>
                    </div>
                    <div class="col-md-1"></div>
                </div>
        ...
        @if (isset($data['luas']) && isset($data['jari']) && isset($data['sisi']))
            <!-- Hasil Output -->
                    ...
                    <div class="card border-success">
                        ...
                        <div class="card-body">
                            <div class="text-end mb-3">
                                <a href="{{ route('kerucut.showPage') }}" class="btn btn-success rounded-3"><i
