                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        ...
                        <div class="title pb-4">
                            <p class="fs-2 text-center text-primary fw-bold">Hitung Luas Limas</p>
                        </div>
                        <!-- Form Input -->
                        <form method="POST" action="{{ route('limas.hitungLuas') }}#hasil">
                            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="card border-2 border-dark shadow bg-danger" style="width: 25rem">
                            <img src="{{ asset('assets/dist/img/BangunRuang/Limas.png') }}" alt="shape.png" class="p-3 rounded-5 ">
                        </div>
                    </div>
                    <div class="col-md-1"></div>
                </div>
                    ...
                    <div class="card border-success">
                        ...
                        <div class="card-body">
                            <div class="text-end mb-3">
                                <a href="{{ route('limas.showPage') }}" class="btn btn-success rounded-3"><i
