...
<body id="top" style="background-color: #F4F9FD">
    ...
    <div class="container-fluid pb-5"
                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        ...
                        <div class="title pb-4">
                            <p class="fs-2 text-center text-primary fw-bold">Hitung Luas Kubus</p>
                        </div>
                        <!-- Form Input -->
                        <form method="POST" action="{{ route('kubus.hitungLuas') }}#hasil">
                            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="card border-2 border-dark shadow bg-warning" style="width: 25rem">
                            <img src="{{ asset('assets/dist/img/BangunRuang/Kubus.png') }}" alt="shape.png" class=" rounded-5 ">
                        </div>
                    </div>
                    <div class="col-md-1"></div>
                </div>
        ...
        @if (isset($data['luas']) && isset($data['sisi']))
            <!-- Hasil Output -->
                    ...
                    <div class="card border-success">
                        ...
                        <div class="card-body">
                            <div class="text-end mb-3">
                                <a href="{{ route('kubus.showPage') }}" class="btn btn-success rounded-3"><i
