        ...
        <div class="row py-5">
                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        ...
                        <div class="title pb-3">
                            <p class="fs-2 text-center text-primary fw-bold font-monospace">Hitung Luas</p>
                        </div>
                        <form action="">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="card border-2 border-dark shadow" style="width: 28rem">
                            <img src="{{ asset('assets/dist/img/logo.png') }}" alt="shape.png" class="p-3 rounded-5 ">
                        </div>
                    </div>
                    <div class="col-md-1"></div>
                </div>
                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-hover border-dark">
                                ...
                                <tbody class="text-center">
                                    ...
                                    <tr>
                                        <td>Rumus</td>
                                        <td colspan="2">Lorem ipsum dolor sit amet consectetur adipisicing elit.</td>
                                    </tr>
                                    <tr>
                                        <td>Luas</td>
                                        <td></td>
