...
<body id="top" style="background-color: #F4F9FD">
    ...
    <div class="container-fluid pb-5"
        ...
        <div class="row py-5">
                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        ...
                        <div class="title pb-4">
                            <p class="fs-2 text-center text-primary fw-bold">Hitung Luas Persegi Panjang</p>
                        </div>
                        <!-- Form Input -->
                        <form method="POST" action="{{ route('persegipanjang.hitungLuas') }}#hasil">
                            @csrf
                            <div class="form-floating mb-5">
                                <input type="number" class="form-control border-1 border-dark fs-5" id="panjang"
                                    @if (isset($data['panjang'])) value="{{ $data['panjang'] }}" @endif name="panjang"
                                    placeholder="Panjang" required>
                                <label for="panjang">Panjang</label>
                            </div>
                            <div class="form-floating mb-5">
                                <input type="number" class="form-control border-1 border-dark fs-5" id="lebar"
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="card border-2 border-dark shadow bg-primary" style="width: 25rem">
                            <img src="{{ asset('assets/dist/img/BangunDatar/Persegi_panjang.png') }}" alt="shape.png" class="p-4 rounded-5 ">
                        </div>
                    </div>
                    <div class="col-md-1"></div>
                </div>
        ...
        @if (isset($data['panjang']) && isset($data['lebar']) && isset($data['luas']))
            <!-- Hasil Output -->
                    ...
                    <div class="card border-success">
                        ...
                        <div class="card-body">
                            <div class="text-end mb-3">
                                <a href="{{ route('persegipanjang.showPage') }}" class="btn btn-success rounded-3"><i
