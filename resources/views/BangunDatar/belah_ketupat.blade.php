                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        ...
                        <div class="title pb-4">
                            <p class="fs-2 text-center text-primary fw-bold font-monospace">Hitung Luas Belah Ketupat
                            </p>
                        </div>
                        <!-- Form Input -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="card border-2 border-dark shadow bg-warning" style="width: 25rem">
                            <img src="{{ asset('assets/dist/img/BangunDatar/Belah_ketupat.png') }}" alt="shape.png" class="rounded-5 ">
                        </div>
                    </div>
                    <div class="col-md-1"></div>
                </div>
                    ...
                    <div class="card border-success">
                        ...
                        <div class="card-body">
                            <div class="text-end mb-3">
                                <a href="{{ route('belahketupat.showPage') }}" class="btn btn-success rounded-3"><i
