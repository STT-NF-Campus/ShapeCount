                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        ...
                        <div class="title pb-4">
                            <p class="fs-2 text-center text-primary fw-bold">Hitung Luas Persegi</p>
                        </div>
                        <!-- Form Input -->
                        <form method="POST" action="{{ route('persegi.hitungLuas') }}#hasil">
                            @csrf
                    ...
                    <div class="card border-success">
                        ...
                        <div class="card-body">
                            <div class="text-end mb-3">
                                <a href="{{ route('persegi.showPage') }}" class="btn btn-success rounded-3"><i
